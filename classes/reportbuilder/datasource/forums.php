...
class forums extends datasource {
    ...
    public static function get_name(): string {
        return get_string('forumsetting', 'local_activitysetting');
    }
    ...
    public static function is_available(): bool {
        ...
        return $DB->get_manager()->table_exists('forum');
    }
    ...
    public function initialise(): void {
        ...
        $forumalias = $forumentity->get_table_alias('forum');
        ...
        $coursejoin = "JOIN {course} $coursealias ON $forumalias.course = $coursealias.id";
        ...
        $gradeitemjoin = "LEFT JOIN {grade_items} $gradeitemalias
                            ON $gradeitemalias.iteminstance = $forumalias.id
